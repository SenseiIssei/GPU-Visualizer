...
class RTX4060Model(BaseGPUModel):
    ...
    def _define_interactive_components(self):
        """Define interactive components for RTX 4060 with hover effects and click animations."""
        self.interactive_components = {
            "gpu_die": {
                "name": "AD107 GPU Die",
                "description": "3,072 CUDA cores, 96 Tensor cores, 24 RT cores, 8GB GDDR6 memory interface",
                "position": (0, 0, 0.1),
                "size": (1.8, 1.8, 0.1),
            ...
            "vram_chips": {
                "name": "GDDR6 VRAM Chips",
                "description": "8x 16Gb GDDR6 chips, 17 Gbps, 272 GB/s bandwidth, 128-bit bus",
                "position": (-3, -2, 0.1),
                "size": (1.2, 0.8, 0.1),
            ...
            "cooling_fans": {
                ...
                "description": "2x 9-blade fans, dual ball bearings, 0dB auto-stop, optimized airflow",
                "position": (-3.6, 0, 3.8),
                "size": (4.0, 4.0, 0.3),
            ...
            "power_delivery": {
                "name": "10-Phase VRM",
                "description": "10-phase power delivery, 45A power stages, digital PWM, 128W TDP support",
                "position": (-6, -3, 0.3),
                "size": (0.6, 0.6, 0.2),
                "color": (0.15, 0.15, 0.2, 0.9),
                "hover_color": (0.25, 0.25, 0.35, 1.0),
            ...
            "memory_controller": {
                ...
                "description": "128-bit memory controller, GDDR6 protocol, error correction, bandwidth optimization",
                "position": (2, -2, 0.15),
                "size": (0.8, 0.6, 0.1),
            ...
            "tensor_cores": {
                "name": "Tensor Cores",
                "description": "96 Tensor cores, FP16/INT8/INT4 operations, sparsity support, 7.4 TFLOPS",
                "position": (0.5, 0.5, 0.12),
                "size": (0.9, 0.9, 0.08),
            ...
            "rt_cores": {
                "name": "RT Cores",
                "description": "24 RT cores, hardware ray tracing, BVH acceleration, real-time reflections",
                "position": (-0.5, 0.5, 0.12),
                "size": (0.8, 0.8, 0.08),
            ...
            "pcie_interface": {
                "name": "PCIe Gen5 x8",
                "description": "PCIe 5.0 x8 interface, 64 GB/s bidirectional, host communication",
                "position": (10.8, 0, -1),
                "size": (1.0, 2.0, 0.5),
            ...
            "display_outputs": {
                ...
                "description": "2x DisplayPort 1.4a, 1x HDMI 2.1, 8K@60Hz HDR, multi-monitor support",
                "position": (10.8, 0, -1),
                "size": (0.8, 3.0, 0.8),
                "color": (0.2, 0.2, 0.25, 0.9),
                "hover_color": (0.35, 0.35, 0.4, 1.0),
    ...
    def show_gpu_die_workflow(self):
        ...
        if self.view3d and hasattr(self.view3d, 'show_workflow_animation'):
            self.view3d.show_workflow_animation("AD107 GPU Die Architecture", "RTX 4060 GPU Die Workflow")
    
    def show_memory_workflow(self):
        """Show memory system workflow."""
        if self.view3d and hasattr(self.view3d, 'show_workflow_animation'):
            self.view3d.show_workflow_animation("GDDR6 Memory System", "RTX 4060 Memory Workflow")
    
    def show_cooling_workflow(self):
        """Show cooling system workflow."""
        if self.view3d and hasattr(self.view3d, 'show_workflow_animation'):
            self.view3d.show_workflow_animation("Cooling System", "RTX 4060 Cooling Workflow")
    
    def show_power_workflow(self):
        """Show power delivery workflow."""
        if self.view3d and hasattr(self.view3d, 'show_workflow_animation'):
            self.view3d.show_workflow_animation("Power Delivery System", "10-Phase VRM Power Delivery")
    
    def show_memory_controller_workflow(self):
        """Show memory controller workflow."""
        if self.view3d and hasattr(self.view3d, 'show_workflow_animation'):
            self.view3d.show_workflow_animation("Memory Controller", "RTX 4060 Memory Controller")
    
    def show_tensor_core_workflow(self):
        """Show tensor core workflow."""
        if self.view3d and hasattr(self.view3d, 'show_workflow_animation'):
            self.view3d.show_workflow_animation("Tensor Core Operations", "RTX 4060 Tensor Core Math")
    
    def show_rt_core_workflow(self):
        """Show RT core workflow."""
        if self.view3d and hasattr(self.view3d, 'show_workflow_animation'):
            self.view3d.show_workflow_animation("Ray Tracing Pipeline", "RTX 4060 RT Core Pipeline")
    
    def show_nvlink_workflow(self):
        """Show NVLink workflow."""
        if self.view3d and hasattr(self.view3d, 'show_workflow_animation'):
            self.view3d.show_workflow_animation("NVLink Interconnect", "RTX 4060 NVLink 4.0")
    
    def show_pcie_workflow(self):
        """Show PCIe workflow."""
        if self.view3d and hasattr(self.view3d, 'show_workflow_animation'):
            self.view3d.show_workflow_animation("PCIe Gen5 Interface", "RTX 4060 PCIe Gen5 x8")
    
    def show_display_workflow(self):
        """Show display output workflow."""
        if self.view3d and hasattr(self.view3d, 'show_workflow_animation'):
            self.view3d.show_workflow_animation("Display Output Pipeline", "RTX 4060 Display Pipeline")
